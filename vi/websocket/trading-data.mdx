...
Kênh này cung cấp dữ liệu realtime liên quan đến **tài khoản giao dịch**: lệnh, sức mua, danh mục — qua Socket.IO. Đây là kênh **khác** với Priceboard (xem [Kết nối Priceboard](https://flashapi.phs.vn/docs/vi/websocket/market-data)) và **yêu cầu access token** hợp lệ.
...
Để nhận dữ liệu bảng giá realtime, xem [Kết nối Priceboard](https://flashapi.phs.vn/docs/vi/websocket/market-data).