...
Priceboard Realtime cung cấp dữ liệu bảng giá theo thời gian thực (giá khớp, dư mua/bán) qua **Socket.IO**, tách biệt hoàn toàn với kênh lệnh/tài sản (Order & Account — xem trang [Kết nối Order & Account](https://flashapi.phs.vn/docs/vi/websocket/trading-data)).
...
Để nhận dữ liệu lệnh, sức mua, danh mục realtime — xem [Kết nối Order & Account (EQT/FNO)](https://flashapi.phs.vn/docs/vi/websocket/trading-data).