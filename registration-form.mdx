      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "4px", position: "relative" }}>
            ...
            <button
              type="button"
              aria-label="How to get your WAN IP"
              onMouseEnter={() => { const t = document.getElementById("ip-wan-tooltip"); if (t) t.style.display = "block"; }}
              onMouseLeave={() => { const t = document.getElementById("ip-wan-tooltip"); if (t && t.dataset.pinned !== "1") t.style.display = "none"; }}
              onClick={() => {
                const t = document.getElementById("ip-wan-tooltip");
                if (!t) return;
                const pinned = t.dataset.pinned === "1";
                t.dataset.pinned = pinned ? "0" : "1";
                t.style.display = pinned ? "none" : "block";
            }}
              style={{
                width: "18px",
                height: "18px",
            ...
            >
              <div style={{ fontWeight: "bold", marginBottom: "6px" }}>How to get your WAN IP</div>

              <ol style={{ margin: 0, paddingLeft: "18px" }}>
                <li>Connect your computer to the Internet network you will use to access OpenAPI.</li>
                <li>Open Google and search for “What is my IP”.</li>
                <li>Provide the IPv4 public IP address that is displayed.</li>
              </ol>
            </div>
          </div>
