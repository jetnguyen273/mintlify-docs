---
title: "Đăng ký OAPI"
description: "Vui lòng điền vào mẫu đăng ký dưới đây để yêu cầu quyền truy cập PHS OpenAPI (Flash API). "
...
showError("Email không hợp lệ.", 1, "notificationEmail");
return;
}
  ...
  <div id="step-1" style={{ display: "flex", flexDirection: "column", flex: 1, overflow: "hidden" }}>
    ...
    <div className="step-scroll-box" style={{ flex: 1, overflowY: "auto", paddingRight: "10px" }}>
      <div style={{ display: "flex", flexDirection: "column", gap: "6px", marginBottom: "18px" }}>
        ...
        >
          Tên Khách Hàng / Tổ chức <span style={{ color: "#e53e3e" }}>\*</span>
        </label>
        ...
        <input
          ...
          required
          minLength={2}
          placeholder="Họ tên hoặc tên tổ chức"
          style={{
            width: "100%",
            padding: "9px 10px",
            borderRadius: "6px",
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "6px", marginBottom: "20px" }}>
        ...
        >
          Số lưu ký / Tài khoản tại PHS <span style={{ color: "#e53e3e" }}>\*</span>
        </label>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2" style={{ gap: "16px" }}>
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            Email (email đăng ký tại PHS) <span style={{ color: "#e53e3e" }}>\*</span>
          </label>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            SĐT <span style={{ color: "#e53e3e" }}>\*</span>
          </label>
    ...
    <div className="flex flex-col-reverse sm:flex-row justify-end gap-3" style={{ marginTop: "20px", paddingTop: "10px", borderTop: "1px solid currentColor", opacity: 0.9, flexShrink: 0 }}>
      ...
      if (!phsCustCode) {
          showError("Số lưu ký / Tài khoản tại PHS là bắt buộc.", "phsCustCode");
          return;
      }
      if (!isValidEmail(notificationEmail)) {
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "4px", position: "relative" }}>
            ...
            >
              IP WAN / IP Whitelist đăng ký <span style={{ color: "#e53e3e" }}>\*</span>
            </label>

            <button
              type="button"
              aria-label="Hướng dẫn lấy IP WAN"
            ...
            >
              <div style={{ fontWeight: "bold", marginBottom: "6px" }}>Cách lấy IP WAN</div>

              <ol style={{ margin: 0, paddingLeft: "18px" }}>
                <li>Kết nối máy tính với mạng Internet sử dụng để truy cập OpenAPI.</li>
                <li>Mở Google và tìm kiếm “What is my IP”.</li>
                <li>Cung cấp địa chỉ IPv4 Public IP được hiển thị.</li>
              </ol>
            </div>
          </div>
